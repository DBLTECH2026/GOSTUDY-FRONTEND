    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="bg-trilce-primary text-text-on-primary rounded-lg p-8 flex items-center justify-between">
        <div className="flex flex-col gap-2">
          <Badge variant="primary" className="!bg-trilce-primary-dark">
            {matricula ? `${matricula.grado.toUpperCase()} ${matricula.nivel.toUpperCase()} — ${matricula.seccion}` : '—'}
          </Badge>
          <h2 className="text-2xl font-bold">Tu plan de estudios este periodo</h2>
        ...
        <div className="text-right">
          <div className="text-4xl font-bold">{cursos.length} cursos</div>
          <div className="text-sm text-trilce-primary-light">{totalHoras} horas / semana</div>
        </div>
      </div>
