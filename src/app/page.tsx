      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-3.5">
        ...
        >
          ...
          <span className="font-bold text-[15px] tracking-tight">
            GOSTUDY <span className="text-text-muted font-medium">·</span>{" "}
            Trilce
          </span>
        </Link>
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      <div
        className="absolute inset-0 bg-grid-trilce pointer-events-none"
        aria-hidden
      />
      <div
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-14 pb-20 lg:pt-20 lg:pb-28 grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        <div className="lg:col-span-7">
          ...
          <h1 className="animate-fade-up delay-1 font-display text-[44px] sm:text-6xl lg:text-7xl font-semibold leading-[1.02] tracking-tight mt-5">
            Estudiar en Trilce
            <br />
            <span className="text-trilce-primary italic">se aprende.</span>
          </h1>

          <p className="animate-fade-up delay-2 max-w-xl text-text-secondary text-lg leading-relaxed mt-5">
            Plataforma oficial de matrícula online del Colegio Trilce. Inscribe
            a tu hijo en línea y accede a su información académica desde
            cualquier lugar.
          </p>
  ...
  const items: Array<{ icon: IconName; title: string; text: string }> = [
    {
      ...
      text: "Plana docente comprometida con la formación integral del estudiante.",
    },
    {
      icon: "BookOpen",
      title: "Libros incluidos",
      text: "Todos los textos del año académico están incluidos en la matrícula.",
    },
    {
      icon: "Building2",
      title: "Hogar escolar",
      text: "Ambientes seguros, modernos y bien equipados para el aprendizaje.",
    },
    {
      icon: "User",
      title: "Tutoría personal",
      text: "Acompañamiento personalizado para cada estudiante y su familia.",
    },
  ];
    ...
    <section id="beneficios" className="max-w-6xl mx-auto px-6 py-20 lg:py-24">
      <Reveal className="text-center max-w-2xl mx-auto">
        ...
        <h2 className="font-display text-4xl md:text-5xl font-semibold leading-[1.05] mt-3">
          ...
          <span className="italic text-trilce-primary">moderna</span>, basada en
          décadas de experiencia.
        </h2>
        <p className="text-text-secondary mt-4 leading-relaxed">
          Combinamos rigor académico, tecnología y cercanía. Esa es la
...
function Proceso() {
  const steps = [
    {
      n: "01",
      title: "Crea la inscripción",
      text: "Completa los datos del estudiante y del apoderado en el formulario online.",
    },
    {
      n: "02",
      title: "Adjunta documentos",
      text: "Sube DNI, foto y partida de nacimiento. Todo de forma segura.",
    },
    {
      n: "03",
      title: "Confirmación",
      text: "Recibes tu número de PIN por correo para acceder al portal.",
    },
    {
      n: "04",
      title: "Matrícula y pago",
      text: "Coordinas la matrícula con el colegio y registras los pagos del año.",
    },
  ];
  ...
  return (
    <section id="testimonios" className="max-w-6xl mx-auto px-6 py-20 lg:py-24">
      <Reveal className="text-center max-w-2xl mx-auto">
        ...
        <h2 className="font-display text-4xl md:text-5xl font-semibold leading-[1.05] mt-3">
          Lo que dicen las{" "}
          <span className="italic text-trilce-primary">familias Trilce</span>
        </h2>
      </Reveal>
        ...
        <div className="relative overflow-hidden rounded-lg bg-trilce-accent text-white p-8 sm:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="relative max-w-xl">
            <h3 className="font-display text-3xl sm:text-4xl font-semibold leading-tight">
              ...
              <span className="italic text-trilce-primary">a tu hijo?</span>
            </h3>
            <p className="text-white/80 mt-3 leading-relaxed">
              El proceso toma alrededor de 5 minutos. Solo necesitas el DNI del
              apoderado y del estudiante. Recibirás el PIN al terminar.
            </p>
          </div>
          <Link
            href="/inscripcion"
...
function Footer() {
  return (
    <footer className="border-t border-border py-8 text-center text-sm text-text-muted">
      © {new Date().getFullYear()} Colegio Trilce. GOSTUDY — Sistema de
      Matrícula Digital.
    </footer>
  );
}
...
function Kpi({ value, label }: { value: string; label: string }) {
  return (
    <div>
      ...
      <dd className="text-xs text-text-secondary mt-1.5 leading-tight">
        {label}
      </dd>
    </div>
  );
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div
          className={`w-11 h-11 rounded-md flex items-center justify-center shrink-0 ${iconBgClass}`}
        >
